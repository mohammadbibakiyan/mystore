    ...
    return(
        <footer className="mt-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 ">
                <div class="mt-8 flex flex-col text-neutral-500 gap-2 text-body-1">
                    <p class="text-neutral-700 text-h5">با دیجی‌من</p>
                ...
                <div class=" mt-8 flex flex-col text-neutral-500 gap-2 text-body-1">
                    <p class="text-neutral-700 text-h5">خدمات مشتریان</p>
                ...
                <div class=" mt-8 flex-col text-neutral-500 gap-2 text-body-1 hidden md:flex">
                    <p class="text-neutral-700 text-h5">راهنمای خرید از دیجی من</p>
                ...
                <div className="col-span-2 md:col-span-1">
                    ...
                    <div className="mt-8">
                        <h4 class="text-h5 text-neutral-700 mb-3">با ثبت ایمیل، از جدید‌ترین تخفیف‌ها با‌خبر شوید</h4>
                        <form className="flex">
